...
data['tooltip'] = f"<h2>{weather['nearest_area'][0]['country'][0]['value']}, {weather['nearest_area'][0]['areaName'][0]['value']}</h2>\n"
data['tooltip'] += f"<h4>{weather['current_condition'][0]['weatherDesc'][0]['value']}, {weather['current_condition'][0]['temp_C']}°C</h4>\n"
